...
from TrainCAGame import CatchEnvironment, X, W1, b1, input_layer, W2, b2, hidden_layer, W3, b3, output_layer, Y, \
    cost, optimizer
...
def drawState(fruitRow,fruitColumn,kind,basket):
    global gridSize
...
with tf.Session() as sess:
    ...
    while (numberOfGames < maxGames):
        ...
        isGameOver = False
        fruitRow, fruitColumn, kind,basket = env.reset()
        currentState = env.observe()
        drawState(fruitRow, fruitColumn, kind, basket)
